...
// import ObjectList from "../../components/ProductList";
// import Input from "../../components/Input";

const GetUsers = React.lazy(() => {
  return new Promise((resolve) =>
    setTimeout(() => resolve(import("../../components/GetUsers")), 2000)
  );
});
const ObjectList = React.lazy(() => {
  return new Promise((resolve) =>
    setTimeout(() => resolve(import("../../components/ObjectList")), 2000)
  );
});
const Input = React.lazy(() => {
  return new Promise((resolve) =>
    setTimeout(() => resolve(import("../../components/Input")), 2000)
  );
});
...
export const Body = () => {
  ...
  return (
    <>
      ...
      <div className="main">
        <Suspense fallback={<ObjectsLoader />}>
